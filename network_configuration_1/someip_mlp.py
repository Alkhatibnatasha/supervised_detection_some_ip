...
from mlp import Trainer,Predictor
from mlp.dataset.utils import seed_everything
...
options["features"] = {"input_dim":int(58*options["window_size"]), "out_dim":1, "h_dims":[int(58*options["window_size"]/8),int(58*options["window_size"]/16)], "h_activ":nn.Tanh(),"out_activ":nn.Sigmoid()}
options["stride"] = 1
