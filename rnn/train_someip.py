...
from rnn.dataset import SOMEIPDataset
from rnn.dataset.utils import save_parameters
...
class Trainer():
    ...
    def train(self):
        ...
        print("Building RNN Classifier model")
        os.chdir(self.cwd_orig)
        self.model = RNN(**self.features).to(self.device)
